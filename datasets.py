...
from ucf import VideoClsDataset, VideoMS


class DataAugmentationForVideoMS(object):
    ...
    def __repr__(self):
        repr = "(DataAugmentationForVideoMS,\n"
        repr += "  transform = %s,\n" % str(self.transform)
...
def build_pretraining_dataset(args):
    transform = DataAugmentationForVideoMS(args)
    dataset = VideoMS(
        root=None,
