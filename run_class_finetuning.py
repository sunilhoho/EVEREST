...
def get_args():
    parser = argparse.ArgumentParser('VideoMS fine-tuning and evaluation script for video classification', add_help=False)
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/path/to/list_ucf101', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--data_set', default='UCF101', choices=['UCF101', 'HMDB51', 'OSCC'],
    ...
    parser.add_argument('--mcm', action='store_true', default=False)
    parser.add_argument('--mcm_ratio', default=0.4, type=float)   
